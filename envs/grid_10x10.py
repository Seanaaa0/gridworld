...
class GridEnv10x10(gym.Env):
    def __init__(self, render_mode=None):
        ...
        self.cell_size = self.screen_width // self.cols
    ...
    def _randomize_terminal(self):
        ...
        pits = random.sample(candidates, k=min(10, len(candidates)))
        for pit in pits:
    ...
    def _step(self, action):
        ...
        # 計算額外懲罰
        penalty = -0.005 * self.visit_count[next_state]
        reward += penalty
